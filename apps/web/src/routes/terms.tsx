      ...
      <InfoCard title="Beta limitations">
        <BulletList
          items={[
            ...
            "The Cloud Evidence Hub page is a read-only demo. Its openpawl-evidence-bundle.json local preview runs in the browser and does not transmit, accept, or store real customer artifacts on CodePawl servers.",
          ]}
        />
      </InfoCard>
