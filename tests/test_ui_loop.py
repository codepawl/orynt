...
def test_gate_closed_loop_missing_failed_and_passed(tmp_path: Path) -> None:
    ...
    failed_loop = report(tmp_path / "failed_loop.json", {"valid": True, "passed_closed_loop_gate": False, "noop_baseline": {"false_improvement_detected": False}, "patch_mode": "deterministic_patch", "difficulty_breakdown": {"easy": {"success_rate": 0.0}}, "accessibility_regression_rate": 0.0, "responsive_regression_rate": 0.0})
    passed_loop = report(tmp_path / "passed_loop.json", {"valid": True, "passed_closed_loop_gate": True, "noop_baseline": {"false_improvement_detected": False}, "patch_mode": "deterministic_patch", "difficulty_breakdown": {"easy": {"success_rate": 1.0}}, "accessibility_regression_rate": 0.0, "responsive_regression_rate": 0.0, "recommended_next_stage": "expand_loop_mixed_50"})
