...
- Phase 4C manual patch calibration is documented in `docs/MANUAL_PATCH_CALIBRATION.md`. It exports copied-task Codex patches and review templates, then requires rendered `manual_patch_import` reports and completed labels before PR screenshot regression review. It does not require CUDA, DOM-aware JEPA, or any model training.
