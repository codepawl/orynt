...
- `.codex/skills/`: CodePawl-specific skills only. Put application-local Codex skills here when they implement or document behavior unique to CodePawl.

## Working Rules

- Keep planning, UI, technical, and skill material in their assigned folders.
- Do not place general-purpose Codex skills in `.codex/skills/`; that folder is only for CodePawl application behavior.
